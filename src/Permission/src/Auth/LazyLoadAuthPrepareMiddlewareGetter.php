...
use rollun\permission\Auth\Middleware\Factory\AuthenticatePrepareDirectFactory;
use Zend\ServiceManager\Factory\FactoryInterface;

class LazyLoadAuthPrepareMiddlewareGetter extends Attribute
{
    /**
     * @var string
     */
    ...
    public function getLazyLoadMiddlewares(Request $request)
    {
        ...
        $result = [LazyLoadMiddlewareGetterInterface::KEY_FACTORY_CLASS => AuthenticatePrepareDirectFactory::class,
